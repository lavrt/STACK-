...
void push(Stack_t * stk, StackElem_t value)
{
    ...
    if (stk->size == stk->capacity)
    {
        ...
        memset(stk->data + stk->size + 1, POISON, (stk->capacity - stk->size) * sizeof(StackElem_t));
...
StackElem_t pop(Stack_t * stk)
{
    ...
    if ((stk->size != 0) && (stk->capacity / stk->size >= REDUCTION_FACTOR) && stk->capacity > INIT_SIZE)
    {
